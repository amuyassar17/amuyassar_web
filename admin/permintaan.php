...
<head>
	...
	<script type="text/javascript">
		function sureToApprove(id){
			if(confirm("Kamu Yakin untuk menyetujunya?")){
		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Permintaan Sewa</h2>
						<div class="right">
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td><a href="javascript:sureToApprove(<?php echo $row['client_id'];?>)" class="ico del">Approve</a><a href="permintaan.php" class="ico edit">Delete</a></td>
							</tr>
							<?php
								}
							?>
