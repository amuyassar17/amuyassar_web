	...
	<section class="listings">
		<div class="wrapper">
			<ul class="properties_list">
				<h2 style="text-align:center; color:#FF0000; font-family: 'Courier New', Courier, monospace">Terimakasih untuk mengirimkan permintaan untuk rental mobil.
				We will get back to you once we verify your payment.<br>
				Silahkan Login Untuk Melihat Status Pemesanan menggunakan email dan Nomor ID sebagai password.</h2>
			</ul>
